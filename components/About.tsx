...
export default function About() {
  return (
    <section className="min-h-screen">
        ...
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <blockquote className="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
            ...
            <p className="my-4">
              ...
              keen eye for design and a drive for innovation. Through my diverse
              range of projects, I aim to showcase my creativity, technical
              proficiency, and dedication to delivering exceptional results.
            </p>
          </blockquote>
      ...
      <div className="grid max-w-screen-lg w-full px-4 pb-8 mx-auto lg:gap-5 xl:gap-10 lg:pb-14 lg:pt-5 lg:grid-cols-12 relative">
