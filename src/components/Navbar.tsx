...
const Navbar = () => {
  ...
  return (
    <div
      className={`fixed top-5 right-0 left-0 px-0 sm:px-5 m-auto w-full sm:w-fit bg-transparent z-[+9999999] text-gray-400 ${
        ...
        {data.map((item, idx) => (
          <Link href={item.href} key={idx}>
            ...
            >
              ...
              <DockIcon
                className={twMerge(pathname === item.href && "text-white")}
              >
                {item.icon}
              </DockIcon>
            </DockItem>
